...
public class MonthlyGoalsAdapter extends  RecyclerView.Adapter<MonthlyGoalsAdapter.helper>{
    ...
    private ArrayList<MonthlyGoalsDataClass> arrayList;
    private int type;
    public MonthlyGoalsAdapter(ArrayList<MonthlyGoalsDataClass> arrayList, int type) {
        this.arrayList = arrayList;
        this.type=type;
    }
    public void updateData(ArrayList<MonthlyGoalsDataClass> arrayList,int type)
    {
        this.arrayList =arrayList;
        this.type=type;
    ...
    public void onBindViewHolder(@NonNull helper holder, @SuppressLint("RecyclerView") int position) {
        holder.name.setText(arrayList.get(position).getGoalName());
