...
import com.app.financialmanagement.databinding.FragmentDailyexpensesBinding;
...
public class Dailyexpenses extends Fragment {
    private FragmentDailyexpensesBinding mBinding;
    private DatabaseReference database;
    private String userId;
    private SweetAlertDialog loading;
    private ArrayList<DailyExpensesDataClass> reachedList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding=FragmentDailyexpensesBinding.inflate(inflater,container,false);

        mBinding.arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navigateToScreen(R.id.action_dailyExpenses_to_financialStatement);
            }
        });
        mBinding.add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navigateToScreen(R.id.action_dailyExpenses_to_addingDailyExpenses);
            }
        });
        funLoading();
        defineItems();
    ...
    private void defineItems() {
        ...
        adapter = new DailyExpensesAdapter(reachedList, 0);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot data : snapshot.getChildren()) {
                        DailyExpensesDataClass item = data.getValue(DailyExpensesDataClass.class);
                        if (item.getUserId().equals(userId)) {
                            reachedList.add(item);
                            cost += calculateTheRange(item.getRange());
    ...
    {
        adapter.setOnItemClickListener(new DailyExpensesAdapter.onItemClickListener() {
            @Override
